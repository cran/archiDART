archidraw<-function(inputlie, res=NULL, unitlength="px", unitangle="d", rotation=0, numdate=NULL, finalscale=NULL, coldate=par("col"), ltydate=par("lty"), lwddate=par("lwd"), main=NULL, xlab=NULL, ylab=NULL, xlim=NULL, ylim=NULL,...){
    ...
    if (is.null(numdate)==TRUE){
      if (length(coldate)>max(LIE[[i]]$Date)){print(paste("Note: The number of colours in coldate is greater than max(Date) in ", filenameslie[i], ".lie", sep=""))}
      if (length(coldate)<max(LIE[[i]]$Date)){print(paste("Note: The number of colours in coldate is lower than max(Date) in ", filenameslie[i], ".lie", sep=""))}
      coldate1<-rep(coldate, length.out=max(LIE[[i]]$Date))
      if (length(ltydate)>max(LIE[[i]]$Date)){print(paste("Note: The number of elements in ltydate is greater than max(Date) in ", filenameslie[i], ".lie", sep=""))}
      if (length(ltydate)<max(LIE[[i]]$Date)){print(paste("Note: The number of elements in ltydate is lower than max(Date) in ", filenameslie[i], ".lie", sep=""))}
      ltydate1<-rep(ltydate, length.out=max(LIE[[i]]$Date))
      if (length(lwddate)>max(LIE[[i]]$Date)){print(paste("Note: The number of elements in lwddate is greater than max(Date) in ", filenameslie[i], ".lie", sep=""))}
      if (length(lwddate)<max(LIE[[i]]$Date)){print(paste("Note: The number of elements in lwddate is lower than max(Date) in ", filenameslie[i], ".lie", sep=""))}
    ...
    if (is.null(numdate)==FALSE) {
      for (l in 1:length(numdate)){if (numdate[l]>max(LIE[[i]]$Date)){print(paste("Note: numdate contains a numerical value greater than max(Date) in ", filenameslie[i], ".lie", sep=""))}}
      if (length(coldate)>max(numdate)){print("Note: The number of colours in coldate is greater than max(numdate)")}
      if (length(coldate)<max(numdate)){print("Note: The number of colours in coldate is lower than max(numdate)")}
      coldate1<-rep(coldate, length.out=max(numdate))
      if (length(ltydate)>max(numdate)){print("Note: The number of elements in ltydate is greater than max(numdate)")}
      if (length(ltydate)<max(numdate)){print("Note: The number of elements in ltydate is lower than max(numdate)")}
      ltydate1<-rep(ltydate, length.out=max(numdate))
      if (length(lwddate)>max(numdate)){print("Note: The number of elements in lwddate is greater than max(numdate)")}
      if (length(lwddate)<max(numdate)){print("Note: The number of elements in lwddate is lower than max(numdate)")}
